document.addEventListener('DOMContentLoaded', () => {
  ...
  hero_eyebrow: 'Impulsionamos o crescimento do seu negócio',
      ...
      value_title: 'Seu atendimento está fazendo sua empresa perder dinheiro?',
      value_subtitle: 'Demora no retorno, mensagens acumuladas e falta de organização fazem clientes desistirem todos os dias.',
      value_1_title: 'Demora no retorno',
      value_1_body: 'Cada minuto de espera aumenta a chance de o cliente fechar com outra empresa e abandonar o seu atendimento.',
      value_1_line_1: 'O interesse do cliente esfria rapidamente',
      value_1_line_2: 'A concorrência responde antes',
      value_1_line_3: 'Cada minuto sem retorno reduz conversão',
      value_2_title: 'Falta de resposta',
      value_2_body: 'Mensagens sem retorno viram vendas perdidas e passam desorganização para clientes atuais e novos.',
      value_2_line_1: 'Pedidos ficam sem acompanhamento',
      value_2_line_2: 'O cliente perde confiança no atendimento',
      value_2_line_3: 'A empresa transmite desorganização',
      value_3_title: 'Perda diária de dinheiro',
      value_3_body: 'Sem automação, sua empresa perde tempo valioso, oportunidades e faturamento todos os dias, de forma contínua.',
      value_3_line_1: 'Mais tempo gasto com tarefas repetitivas',
      value_3_line_2: 'Menos produtividade da equipe',
      value_3_line_3: 'Menos vendas e menor rentabilidade',
      ...
      solution_1_line_1: 'Atendimento sem fila de espera',
      solution_1_line_2: 'Respostas a qualquer hora sem limite de horário',
      solution_1_line_3: 'Mais agilidade no primeiro contato',
      solution_1_line_4: 'Melhor experiência do cliente',
      solution_2_title: 'Organização automática',
      solution_2_body: 'Pedidos e solicitações organizados sem retrabalho.',
      solution_2_line_1: 'Informações centralizadas em um só lugar',
      solution_2_line_2: 'Menos retrabalho no dia a dia',
      solution_2_line_3: 'Solicitações mais bem registradas',
      solution_2_line_4: 'Mais controle sobre a operação',
      solution_3_title: 'Triagem inteligente',
      solution_3_body: 'Cada cliente segue o melhor caminho com clareza.',
      solution_3_line_1: 'Encaminhamento mais preciso',
      solution_3_line_2: 'Contexto antes do atendimento humano',
      solution_3_line_3: 'Mais rapidez na tomada de decisão',
      solution_3_line_4: 'Redução de falhas no processo',
      solution_4_title: 'Segmentado por setor',
      solution_4_body: 'Cada cliente vai para o time correto sem confusão.',
      solution_4_line_1: 'Projetos sob medida para cada operação',
      solution_4_line_2: 'Controle de dados e processos',
      solution_4_line_3: 'Acesso online com mais praticidade',
      solution_4_line_4: 'Suporte contínuo para evolução',
      ...
      bot_type_1_line_1: 'Respostas padronizadas',
      bot_type_1_line_2: 'Fluxo controlado por etapas',
      bot_type_1_line_3: 'Ideal para rotinas objetivas',
      bot_type_2_title: 'Inteligência Artificial',
      bot_type_2_body: 'Entende intenção e adapta respostas.',
      bot_type_2_line_1: 'Interpretação de contexto',
      bot_type_2_line_2: 'Respostas mais naturais',
      bot_type_2_line_3: 'Mais flexibilidade no atendimento',
      bot_type_3_title: 'Híbrido',
      bot_type_3_body: 'Regras + IA para controle e flexibilidade.',
      bot_type_3_line_1: 'Controle com inteligência',
      bot_type_3_line_2: 'Triagem mais precisa',
      bot_type_3_line_3: 'Equilíbrio entre padrão e adaptação',
      mvi_title: 'Nova solução em desenvolvimento',
      mvi_subtitle: 'Estamos desenvolvendo uma integração entre câmeras, alarmes e gerenciamento direto pelo WhatsApp, trazendo mais praticidade e agilidade no acompanhamento da segurança.',
      mvi_point_1: 'Confirmação visual de disparos e eventos em grupo.',
      mvi_point_2: 'Gerenciamento de ocorrências e acionamentos via WhatsApp.',
      mvi_point_3: 'Integração projetada com câmeras, alarmes e sistemas já existentes.',
      mvi_point_4: 'Projeto em desenvolvimento, já disponível para esclarecimento de dúvidas comerciais e técnicas.',
  ...
  mvi_card_title: 'Como funciona',
      ...
      segment_company: 'Empresas e serviços',
      segment_home: 'Comércio e varejo',
      ...
      segment_note: 'A solução é adaptável para condomínios, comércios, empresas de serviços, clínicas, assistências técnicas, indústrias, imobiliárias e qualquer operação que precise de atendimento prático, organizado e imediato.',
      ...
      process_step_1_body: 'Analisamos a demanda e definimos o melhor fluxo para a operação.',
    ...
    en: {
      ...
      value_title: 'Is your service making your company lose money?',
      value_subtitle: 'Slow replies, message overload, and lack of organization make customers give up every day.',
      value_1_title: 'Slow response',
      value_1_body: 'Every minute of waiting increases the chance that the customer buys from another company and abandons your service.',
      value_1_line_1: 'Customer interest cools down quickly',
      value_1_line_2: 'Competitors answer first',
      value_1_line_3: 'Every minute without a reply hurts conversion',
      value_2_title: 'No reply',
      value_2_body: 'Unanswered messages turn into lost sales and make the company look disorganized to current and new customers.',
      value_2_line_1: 'Requests are left without follow-up',
      value_2_line_2: 'The customer loses trust in the service',
      value_2_line_3: 'The company looks disorganized',
      value_3_title: 'Daily revenue loss',
      value_3_body: 'Without automation, your company loses time, opportunities, and revenue every day, continuously.',
      value_3_line_1: 'More time spent on repetitive tasks',
      value_3_line_2: 'Lower team productivity',
      value_3_line_3: 'Fewer sales and lower profitability',
      ...
      solution_1_line_1: 'No waiting queue',
      solution_1_line_2: 'Responses at any time',
      solution_1_line_3: 'More speed on first contact',
      solution_1_line_4: 'Better customer experience',
      solution_2_title: 'Automatic organization',
      solution_2_body: 'Orders and requests organized with no manual effort.',
      solution_2_line_1: 'Centralized information',
      solution_2_line_2: 'Less rework in daily routine',
      solution_2_line_3: 'Requests better recorded',
      solution_2_line_4: 'More operational control',
      solution_3_title: 'Smart triage',
      solution_3_body: 'Each customer follows the best path with full context.',
      solution_3_line_1: 'More precise routing',
      solution_3_line_2: 'Context before human service',
      solution_3_line_3: 'Faster decision-making',
      solution_3_line_4: 'Fewer process failures',
      solution_4_title: 'Department routing',
      solution_4_body: 'Each customer goes to the right team with full context.',
      solution_4_line_1: 'Tailored projects for each operation',
      solution_4_line_2: 'Data and process control',
      solution_4_line_3: 'Online access with more practicality',
      solution_4_line_4: 'Continuous support for evolution',
      ...
      bot_type_1_line_1: 'Standardized responses',
      bot_type_1_line_2: 'Step-by-step controlled flow',
      bot_type_1_line_3: 'Ideal for objective routines',
      bot_type_2_title: 'Artificial Intelligence',
      bot_type_2_body: 'Understands intent and adapts responses.',
      bot_type_2_line_1: 'Context interpretation',
      bot_type_2_line_2: 'More natural responses',
      bot_type_2_line_3: 'More flexibility in service',
      bot_type_3_title: 'Hybrid',
      bot_type_3_body: 'Rules + AI for control and flexibility.',
      bot_type_3_line_1: 'Control with intelligence',
      bot_type_3_line_2: 'More precise triage',
      bot_type_3_line_3: 'Balance between standard and adaptation',
      mvi_title: 'Smart Verification Module',
      mvi_subtitle: 'In development. We are designing an integration between cameras, alarms, and WhatsApp for fast and organized incident management.',
      mvi_point_1: 'Visual confirmation of alarms and grouped events.',
      mvi_point_2: 'Incident management and team activation through WhatsApp.',
      mvi_point_3: 'Planned integration with existing cameras, alarms, and systems.',
      mvi_point_4: 'Project in development, already open for commercial and technical questions.',
      mvi_panel_title: 'In development',
      mvi_panel_body: 'The project includes camera and alarm integration with WhatsApp-based management, delivering visual validation, faster activation, and stronger operational control. We can already present the proposal and answer questions about the solution.',
      ...
      segment_company: 'Companies and services',
      segment_home: 'Retail and commerce',
      ...
      segment_note: 'The solution adapts to condominiums, retail, service companies, clinics, tech support, industries, real estate, and any operation that needs practical, organized, and immediate service.',
      ...
      process_step_1_body: 'We analyze the demand and define the best flow for the operation.',
  ...
  const segments = {
    pt: {
      condominio: {
        title: 'Condomínios',
        body: 'Atendimento de moradores, registro de ocorrências, liberação de acessos e comunicação imediata com mais organização e rastreabilidade.'
      },
      empresa: {
        title: 'Empresas e serviços',
        body: 'Triagem de clientes, direcionamento por setor, agendamentos, suporte e acompanhamento de demandas com mais segurança, padronização e produtividade.'
      },
      residencia: {
        title: 'Comércio e varejo',
        body: 'Atendimento rápido para pedidos, orçamento, dúvidas, confirmação de compra, status de entrega e pós-venda com mais praticidade.'
      }
    },
    en: {
      condominio: {
        title: 'Condominiums',
        body: 'Resident service, occurrence records, access releases, and immediate communication with more organization and traceability.'
      },
      empresa: {
        title: 'Companies and services',
        body: 'Client triage, department routing, scheduling, support, and demand tracking with more security, standardization, and productivity.'
      },
      residencia: {
        title: 'Retail and commerce',
        body: 'Fast service for orders, quotes, questions, purchase confirmation, delivery status, and after-sales support with more practicality.'
      }
    }
  };
